...
const maintenanceScheduleData = {
  ...
  "Honda": [
    ...
    { id:"transfluid", task:"Transmission Fluid", icon:"⚙️", intervalMiles:30000, intervalMonths:null, notes:"Minder code 3. Most models: 30–45k. 9/10-speed push-button shift: every 50k. CVT-equipped Hondas: inspect at 30k.", repairKey:"Transmission Fluid" },
